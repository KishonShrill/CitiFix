/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 0c22518ec7d52d037326f72bc3921f43)
// Runtime types generated with workerd@1.20260918.1 2026-09-17 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CITYFIX_KV_CACHE: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXT_PUBLIC_GOOGLE_CLIENT_ID: "942756139317-qhoma3pvf523s3eeq250cea35t9hj04s.apps.googleusercontent.com";
	BETTER_AUTH_SECRET: string;
	BETTER_AUTH_URL: string;
	NEXT_PUBLIC_SCAN: string;
	LOCAL_IP: string;
	DATABASE_URL: string;
	...
	WORKER_SELF_REFERENCE: Fetcher /* citifix */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_GOOGLE_CLIENT_ID" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "NEXT_PUBLIC_SCAN" | "LOCAL_IP" | "DATABASE_URL" | "SUPABASE_PUBLISHABLE" | "SUPABASE_SECRET" | "NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME" | "NEXT_PUBLIC_CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET">> {}
}
