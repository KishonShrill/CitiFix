/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 3f9ca209570baee7603954269f55f44f)
// Runtime types generated with workerd@1.20260918.1 2026-09-17 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	CITYFIX_KV_CACHE: KVNamespace;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	SUPABASE_PUBLISHABLE: "sb_publishable_ACJWlzQHlZjBrEguHvfOxg_3BJgxAaH";
	NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME: "dlmabgte3";
	NEXT_PUBLIC_CLOUDINARY_API_KEY: "264546821783396";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_PUBLISHABLE" | "NEXT_PUBLIC_CLOUDINARY_CLOUD_NAME" | "NEXT_PUBLIC_CLOUDINARY_API_KEY" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "DATABASE_URL">> {}
}
